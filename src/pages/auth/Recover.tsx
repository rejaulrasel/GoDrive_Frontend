...
import {
  TAuthEmail,
  TNotificationEmail,
} from "../../interface/email.emailjs.params.interface";
    ...
    if (!passwordRegex.test(password)) {
      ...
      if (res.data.success) {
        const EMAIL_PARAMS: TNotificationEmail = {
          ...
          name: user?.name as string,
          email: user?.email as string,
          description: `We happy to inform you that your GoDrive account has been successfully recovered. You can now log in to your account using your new password. 
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-1 justify-center h-full px-5 md:px-10 flex-col">
            ...
            >
              ...
              <button
                ...
                className={`py-2 px-3 border hover:bg-rose-700 transition-all border-rose-600 bg-rose-600 text-white rounded-r-md`}
              >
                Search
              </button>
            </form>
          ...
          {/* profile details */}
          {user && !passed && (
            <div data-aos="zoom-out" className="flex-1 border-t md:border-t-0">
              <p
