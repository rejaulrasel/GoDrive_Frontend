...
const ProfileSettings = () => {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetFullUserQuery([{ email: user?.user }], { skip: !user });
  ...
  const handleChangeUserDetails: SubmitHandler<FieldValues> = async (data) => {
    ...
    if (data.password) {
      ...
      if (!passwordRegex.test(data.password)) {
        ...
        if (serverResponse.data?.success) {
          toast.success("Profile Details Updated, Places Login again 😊", {
            id: toastId,
          });
          dispatch(logout());
          navigate("/auth/login");
  ...
  return (
    <div className="">
      ...
      <div
        data-aos="fade-left"
        className="max-w-full mt-5 md:mx-10 p-6 bg-white shadow-md rounded-lg"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <div className="flex flex-col items-start mb-4">
              <div className="relative group">
                <img
                  src={
                    fullUser?.data?.photo ? fullUser?.data?.photo : demoProfile
                  }
                  alt="Profile"
              ...
              <p className="text-gray-600">
                {fullUser?.data?.role === "user" ? "Customer" : "Admin"}
              </p>
            </div>
            <div className="mb-4">
          ...
          <div>
            ...
            <form
              className="space-y-4"
              onSubmit={handleSubmit(handleChangeUserDetails)}
            >
              ...
              <div>
                ...
                <small className="ml-2">
                  If you change the password, you will need to login again
                </small>
              </div>
