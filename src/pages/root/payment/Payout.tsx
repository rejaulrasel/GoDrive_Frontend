...
const stripePromise = loadStripe(
  "pk_test_51Q3hpbK7vhJ1FJpUwCQDZIVHxxy012XXK6LPKVdKKmj2LDfRupQxISwtGe4aoWXtUONMTQHVHdsSUvSZ2NBnZYpY00nykqdqOp"
);
              ...
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                ...
                >
                  <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                    <Link
                      to={"/dashboard/user/bookings/manage"}
                    ...
                    <div className="flex flex-col md:flex-row mt-10">
                      <div className="lg:w-1/2">
                        <h1 className="text-start text-2xl font-bold flex items-center">
                        ...
                        <div className="overflow-x-auto">
                          <p className="py-5 pr-10">
                            Welcome to GoDrive payment system. Hope you get a
                            good payment experience from here
                          </p>
                        </div>
                      </div>
                      <div className="lg:w-1/2">
