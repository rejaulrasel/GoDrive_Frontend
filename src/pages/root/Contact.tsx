        ...
        <section className="bg-gray-100 py-12 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              ...
              booking, need assistance, or just want to give us feedback, feel
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  <div className="bg-white p-4 rounded-lg shadow-md w-full">
                    ...
                    <p className="text-lg text-gray-600">
                      Call us at:{" "}
                      <a href="tel+8801232454255" className="text-rose-600">
                        +880 1232-454255
                      </a>
                    </p>
                    <p className="text-lg text-gray-600">
                ...
                <div className="flex items-center">
                  <div className="bg-white p-4 rounded-lg shadow-md w-full">
                    ...
                    <p className="text-lg text-gray-600">
                      123 GoDrive HQ, Rangpur, Bangladesh
                    </p>
                    <p className="text-lg text-gray-600">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="w-full h-64 bg-gray-200 rounded-lg shadow-md">
              ...
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14375.22845120466!2d89.27522699056138!3d25.743891577437427!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39e32de6fca6019b%3A0x9fa496e687f818c8!2sRangpur!5e0!3m2!1sen!2sbd!4v1725338239792!5m2!1sen!2sbd"
