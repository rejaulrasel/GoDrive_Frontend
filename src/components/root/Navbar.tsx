      ...
      <nav className="flex z-20 border-b items-center justify-between text-[#393E46] px-4 py-2 bg-white">
        ...
        <ul className="hidden items-center justify-between gap-10 md:flex">
          ...
          <NavLink to={"/vehicles"}>
            <li className="group flex  cursor-pointer flex-col">
              ...
              <span
                className={`mt-[2px] h-[3px] ${
                  currentRoute === "vehicles" ? "w-full" : "w-0"
                } rounded-full bg-rose-600 transition-all duration-300 group-hover:w-full`}
              ></span>
            </li>
          </NavLink>
          ...
          <NavLink to={"/contact"}>
            <li className="group flex  cursor-pointer flex-col">
              ...
              <span
                className={`mt-[2px] h-[3px] ${
                  currentRoute === "contact" ? "w-full" : "w-0"
                } rounded-full bg-rose-600 transition-all duration-300 group-hover:w-full`}
              ></span>
            </li>
          </NavLink>
        ...
        <div className="flex md:hidden justify-center items-center z-20">
          ...
          <div
            ...
            className="relative z-30 flex transition-transform md:hidden"
          >
            <svg
            ...
            {dropDownState && (
              <ul className=" z-10 bg-white  gap-2 border  text-[#393E46]  absolute right-0 top-11 flex w-[200px] flex-col  rounded-lg   text-base ">
                ...
                <NavLink to={"/vehicles"}>
                  <li className="cursor-pointer  px-6 py-2 ">Vehicles</li>
                </NavLink>
                <NavLink to={"/about"}>
                  <li className="cursor-pointer  px-6 py-2 ">About</li>
                </NavLink>
                <NavLink to={"/contact"}>
