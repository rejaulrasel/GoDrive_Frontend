      ...
      >
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto my-4 w-full max-w-xl  text-center text-gray-400">
            At GoDrive, we go beyond just providing cars—we deliver a premium
        ...
        <div className="relative mx-auto max-w-7xl grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-md hover:scale-105 transition-all border border-gray-200 bg-gray-100 p-8 text-center shadow">
            ...
            <p className="my-4 mb-0  text-gray-700">
              ...
              get the best value for your money every time you rent with us.
            </p>
          </div>
          ...
          <div className="rounded-md hover:scale-105 transition-all border border-gray-200 bg-gray-100 p-8 text-center shadow">
            ...
            <p className="my-4 mb-0  text-gray-700">
              We're here for you around the clock, providing dedicated
              assistance whenever you need it, making your rental experience
              hassle-free.
            </p>
          </div>
          ...
          <div className="rounded-md hover:scale-105 transition-all border border-gray-200 bg-gray-100 p-8 text-center shadow">
            ...
            <p className="my-4 mb-0  text-gray-700">
              From luxury cars to rugged SUVs, our extensive fleet ensures you
              find the perfect ride to match your style and needs.
            </p>
          </div>
        </div>
      </section>
