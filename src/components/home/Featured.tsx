        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
          <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <p className="mt-4 text-gray-700">
              Feel the adrenaline with our sleek, high-powered vehicles, built
          ...
          <div data-aos="fade-left" className="-mx-6 lg:col-span-2 lg:mx-0">
            <div ref={sliderRef} className="keen-slider">
              {data?.data
                ?.slice(2, 5)
                .map((vehicle: TVehicleResponse, indx: number) => {
                  return (
                        ...
                        <blockquote className="flex h-full flex-col justify-between bg-white shadow-sm">
                          <div className="relative border flex flex-col md:flex-row bg-white ">
                            ...
                            <div className="w-full md:w-[50%] bg-white flex flex-col space-y-2 p-6">
                              <h3 className="font-semibold text-gray-800 text-xl mt-1">
                                {vehicle?.name}
                              </h3>
